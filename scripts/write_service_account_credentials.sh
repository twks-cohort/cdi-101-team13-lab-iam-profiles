...
terraform output DPSNonprodServiceAccount_encrypted_aws_secret_access_key | sed 's/"//g' | base64 -d | gpg -dq --passphrase ${GPG_KEY_PASSPHRASE} |  opw write CDI101Team13-aws DPSNonprodServiceAccount-aws-secret-access-key -
terraform output DPSNonprodServiceAccount_aws_access_key_id | tr -d \\n | sed 's/"//g' | opw write CDI101Team13-aws DPSNonprodServiceAccount-aws-access-key-id -
